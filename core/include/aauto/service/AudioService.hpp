...
// Options for one AudioService instance. The app layer creates one of these
// per audio stream the platform supports (typically media + guidance + system,
// but a head unit may omit any of them).
